...
const Formss = () => {
  ...
  return (
    <div className="bg-red-100 sm:w-full sm:px-[24px] sm:py-[24px] md:px-[32px] md:py-[32px] flex flex-col">
      <h1 className="sm:text-[32px] md:text-[48px] font-light leading-tight mb-8">
        Contact Us for <span className="text-red-600 ">Rapid Response!!</span>{" "}
        <br />
      </h1>
      <Formik
